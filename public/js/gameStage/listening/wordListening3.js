let words = [
    {
      ...
      choices: ["A. Turn back, and try another way", "B. We have to surrender. Enemies are much stronger", "C. Make a deal with them and join their ship", "D. We fight them, we're strong because we're together"],
      correctAnswer: 3,
      audio: "/audio/Pop 31.mp3", // Path relatif dari public
    },
    {
      hint: "What is the correct answer?",
      choices: ["A. Yes", "B. No", "C. Maybe", "D. I don't know"],
      correctAnswer: 0,
